    ...
    <div class="col-md-9 panel">
        ...
        <div class="col-md-12"> 
            <table id="document-table" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $__currentLoopData = $dirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                <tr>
                    <td><?php echo e(++$id); ?></td>
                    <td><a href="<?php echo e(URL::to('document/mydirectory_table/'.$path)); ?>" class="open-folder" style="color: orange;"><i class="fa fa-folder"></i> <?php echo e($item['name']); ?></td>
                    ...
                    <td class="text-center hidden-print">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                <li><a title = "View" href="<?php echo e(URL::to('document/mydirectory_table/'.$path)); ?>"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo e(trans('file.View')); ?>/<?php echo e(trans('file.Edit')); ?></a></li>
                                <li class="divider"></li>
                                <li><a title = "Delete" href="#" class="del-btn" path="<?php echo e($item['path']); ?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo e(trans('file.Delete')); ?></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td><?php echo e(++$id); ?></td>
                    <td><a href="<?php echo e(asset($path)); ?>" target="_blank"><i class="fa fa-file"></i> <?php echo e($item['name']); ?></td>
                    <td><?php echo e($item['date']); ?></td>
                    <td><?php echo e($item['type']); ?></td>
                    <td><?php echo e($item['size']); ?></td>
                    <td class="text-center hidden-print">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                <li><a title = "View" href="<?php echo e(asset($path)); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo e(trans('file.View')); ?></a></li>
                                <li class="divider"></li>
                                <li><a title = "Edit" id="edit-btn" path="<?php echo e($item['path']); ?>"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo e(trans('file.Edit')); ?></a></li>
                                <li class="divider"></li>
                                <li><a title = "Download" href="<?php echo e(asset($path)); ?>" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i> <?php echo e(trans('file.Download')); ?></a></li>
                                <li class="divider"></li>
                                <li><a title = "Delete" href="#" class="del-btn" path="<?php echo e($item['path']); ?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo e(trans('file.Delete')); ?></a></li>
                            </ul>
                        </div>
        ...
        <div class="col-md-12 panel">
            ...
            <div>
                ...
                <div class="form-group submit text-right">
                    ...
                    <div class="form-group-inner">
                         <div class="field-outer">
                           <input type="submit" name="submit" value="<?php echo e(trans('file.Submit')); ?>" class="btn btn-primary" id="import-document-ok">
                         </div>
                    </div>
                </div>                
             </div>
        ...
        <div class="modal-body">
          <div class="col-md-12">
                ...
                <div class="form-group">
                     ...
                     <div class="form-group-inner">
                         <div class="field-outer">
                             <input required class="form-control" type="text" name="title" id="document-title" placeholder="<?php echo e(trans('file.Trade License')); ?>">
                         </div>
                     </div>
                </div> 
                <div class="form-group">
    ...
    $(document).ready(function() {
        $('#create-folder-ok').click(function () {
            ...
            if(!name) alert("Please enter folder name!");
                ...
                $.ajax({
                    url: "<?php echo e(URL::to('document/folder_create')); ?>",
                    type: "POST",
                    data: {
                        name: name,
                        path: "<?php echo e($real_path); ?>"
                    },
        ...
        $('#import-document-ok').click(function() {
            ...
            if(!ldms_documentTitle || !category_id || !ldms_email) {
                ...
                if(!ldms_documentFile) {
                    ...
                    formData.append('path', "<?php echo e($real_path); ?>");
                    formData.append('file', $('#ldms_documentFile')[0].files[0]);
                    $.ajax({
                        url: "<?php echo e(URL::to('/document/file_upload')); ?>",
                        type: 'post',
        ...
        $('#edit-btn').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/document/get_document_info')); ?>",
                type: "POST",
                data: {
                    path: path
                },
        ...
        $('#edit-document-ok').click(function() {
            ...
            if(!title || !category_id || !expired_date) {
                ...
                $.ajax({
                    url: "<?php echo e(URL::to('/document/update_document')); ?>",
                    type: "POST",
                    data: {
                        title: title,
                        id: id,
        ...
        $('#delete-one-ok').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/document/delete_one')); ?>",
                type: "post",
                data: {
