        ...
        <div class="col-md-6 col-offset-md-6">
            <div class="col-md-12 panel">
                ...
                <div class="form-group col-md-12">
                     ...
                     <div class="form-group-inner">
                         <div class="field-outer">
                             <input required class="form-control" type="text" name="title" id="ldms_documentTitle" value="<?php echo $document["title"]; ?>">
                         </div>
                     </div>
                </div> 
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                     ...
                     <div class="form-group-inner">
                         <div class="field-outer">
                            <input required class="form-control" type="email" name="ldms_email" id="ldms_email" value="<?php echo $document["email"]; ?>">
                         </div>
                     </div>
                </div>
                <div class="form-group col-md-12">
                     ...
                     <div class="form-group-inner">
                         <div class="field-outer">
                            <input class="form-control" type="text" name="tags_for_search" value="<?php echo $document["tags_for_search"]; ?>">
                         </div>
                     </div>
                </div>
                <div class="form-group col-md-12">
