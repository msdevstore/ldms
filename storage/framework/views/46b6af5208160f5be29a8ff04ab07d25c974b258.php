    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown text-center">
        ...
        <ul class="dropdown-menu" role="menu">
          ...
          <li><a href="<?php echo e(action("DocumentController@ldmsUpdateProfile")); ?>"><i class="fa fa-cogs"></i> <?php echo e(trans('file.User Options')); ?></a></li>
          <?php
          ...
          <li><a href="<?php echo e(action("UserController@create")); ?>"><i class="fa fa-user"></i> <?php echo e(trans('file.Create User Account')); ?></a></li>
          <li><a href="<?php echo e(url('categories')); ?>"><i class="fa fa-bookmark-o"></i> <?php echo e(trans('file.Categories')); ?></a></li>
