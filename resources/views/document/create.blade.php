  ...
  <div class="col-md-9">     
    ...
    <div class="col-md-12 panel">
        ...
        <div class="container-fluid">
            <div class="col-md-3">
                <a href="#" data-toggle="modal" data-target="#importProduct" class="btn btn-primary"><i class="fa fa-file"></i> {{trans('file.Import Document')}}</a>
            </div>
            <div class="col-md-9">
                ...
                @foreach($document_list as $key=>$document)
                  ...
                  ?>   
                        <tr class=<?php if ($expiredDate<$todayDate) {
                            ...
                            <td>@if($category != ''){{ $category}} @else {{ trans('file.Uncategorized') }}@endif</td>
                            <td>{!! date('d-m-Y', strtotime($document->expired_date)) !!}</td>
                            <td>{!! $document->email !!}</td>
                            <td>{!! $document->mobile !!}</td>
                            <td>{!! $document->tags_for_search !!}</td>
                            <td class="text-center hidden-print">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        <li><a title = "View" href="ldms_edit/{!! $document->id !!}"><i class="fa fa-eye" aria-hidden="true"></i> {{trans('file.View')}}/{{trans('file.Edit')}}</a></li>
                                        <li class="divider"></li>
