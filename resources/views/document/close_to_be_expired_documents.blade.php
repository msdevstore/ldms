...
@if(count($document_list)!=0)
  <div class="col-md-9">     
    ...
    <div class="col-md-12 panel">
        <h1>{{trans('file.Close To Be Expired Document')}}(<?php echo $ldms_total_documents_number;?>)</h1>
...
@else
  <div class="col-md-8 col-md-offset-2">
    <div class="col-md-12 panel">
    <h1 class="text-danger">{{trans('file.No Expiring Soon Documents to Show')}}</h1>
        <h3>{{trans('file.Upload New Document')}}</h3>
@endif          
